...
export const TEAM_MEMBERS: TeamMember[] = [
  ...
  { id: 'member6',  slug: '/team/member6',  name: 'Munir Xamrayev',        role: 'Web Content Editor',             ...PLACEHOLDER },
  { id: 'member7',  slug: '/team/member7',  name: 'Ahmed Niaz',            role: 'Lead Web Developer & Architect', ...PLACEHOLDER },
  { id: 'member8',  slug: '/team/member8',  name: 'Alishir Faik',          role: 'UI/UX Designer',                 ...PLACEHOLDER },
